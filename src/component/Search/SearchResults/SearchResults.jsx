                     ...
                     <div className={styles.border}>
                            <div className={styles.innerContainer}>
                                   ...
                                   <div className={styles.lowerPart}>
                                          {episodeData.map((episode, index)=><div className={styles.resultsPill}onClick={()=>sendToEpisode(episode.podcastID, episode.episodeID)}><ResultsPill podcastTitle={episode.podcastTitle} label={episode.episodeTitle} episodeThumbnail={episode.episodeThumbnail} avgRating={episode.averageRating} totalReviews={episode.totalReviews}/></div>)}
                                   </div>
                            </div>
                     </div>
              </div>

...
def lambda_handler(event, context):
    ...
    try: 
        ...
        if item["transcribedStatus"] == "NOT ELIGIBLE FOR TRANSCRIPTION":
            return {
            'statusCode': 200,
            'headers': {
                'Content-Type': 'application/json',
            ...
            'body': json.dumps({
                "Message": "Cannot start a TRANSCRIPTION job. This episode was previously marked as NOT ELIGIBLE FOR TRANSCRIPTION"
            })
        }
